...
var StreameursToFocusOn =  [
  {name:"channelname1",ID:"idchannel1",streamdata:"",streamstatut:"offline",webhook:hook},{name:"channelname2",ID:"idchannel2",streamdata:"",streamstatut:"offline",webhook:hook2}
  ];
...
function CheckIfLive(ChoosenStreamer){ 
 ...
 options = {
  ...
  var newData;
  setInterval(function() {CheckIfLive(StreameursToFocusOn[0].ID); }, 30000); //example1
  setInterval(function() {CheckIfLive(StreameursToFocusOn[1].ID);}, 30000); //example2
